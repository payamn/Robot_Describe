...
class Map_Model:
    ...
    def model_forward(self, batch_size, mode, iter, plot=False):
        ...
        for batch, (target_classes, target_poses, target_objectness, local_map, laser_map) in enumerate(iter_data_loader):
            ...
            # if  mode == "train": # with probability 10/11
            #
            #     mask_classes = target_classes >= 2
            #
            #     mask_objectness = mask_classes * mask_objectness
            ...
            loss_total = (330*loss_classes+loss_poses + 100*loss_objectness)/431
            ...
            if mode== "train" and loss_total.item()>0:
                loss_total.backward()
                self.optimizer.step()
